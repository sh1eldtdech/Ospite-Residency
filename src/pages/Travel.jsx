...
const attractions = [
  {
    ...
    img: 'https://images.unsplash.com/photo-1596895111956-bf1cf0599ce5?w=700&q=80',
    category: 'Nature',
  },
  {
  ...
  },
  {
    ...
    img: 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?w=700&q=80',
    category: 'Spiritual',
  },
  {
    name: 'Luing Garden',
...
const tips = [
  { icon: '🌡️', title: 'Best Season', desc: 'October–December & March–May offer clear skies and pleasant weather.' },
  { icon: '🎒', title: 'Pack Smart', desc: 'Carry warm layers even in summer — mountain evenings can be cool.' },
  { icon: '🚗', title: 'Getting Around', desc: 'We offer pick-up & drop services. Shared jeeps are popular for inter-city travel.' },
  { icon: '📜', title: 'Permits', desc: 'Indian nationals need an Inner Line Permit for North Sikkim. Apply at Gangtok\'s SNT stand.' },
]
    ...
    <div>
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full">
          <p className="text-gold-400 text-xs uppercase tracking-[0.35em] font-body mb-2">Explore Gangtok</p>
          <h1
            className="text-5xl md:text-7xl font-display font-semibold text-cream max-w-xl"
            style={{ fontFamily: "'Cormorant Garamond', serif" }}
          >
            Discover the <span className="italic text-gold-400">Magic</span> of Sikkim
          </h1>
        </div>
      </section>
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {attractions.map((place) => (
            <div key={place.name} className="card-3d bg-cream rounded-3xl overflow-hidden shadow-lg flex flex-col">
      ...
      <section className="bg-forest-700 py-20 px-6">
        <div className="max-w-5xl mx-auto text-center">
          <p className="text-xs uppercase tracking-[0.35em] text-gold-400 font-body mb-3">Find Us</p>
          <h2
          ...
          <p className="text-cream/60 font-body mb-8">Suhim Colony, Helipad Road, Sichey, Gangtok – 737101</p>
      ...
      <section className="py-24 px-6 max-w-6xl mx-auto">
        <div ref={r2} className="reveal">
          <SectionTitle tag="Traveller Tips" title="Plan Your Visit" sub="Expert advice to make your Gangtok trip unforgettable." />
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          {tips.map(({ icon, title, desc }) => (
            <div key={title} className="icon-tilt bg-parchment rounded-2xl p-7 text-center border border-gold-300/30 shadow-sm">
              ...
              <p className="text-sm text-forest-500 font-body leading-relaxed">{desc}</p>
            </div>
          ))}
        </div>
      </section>
